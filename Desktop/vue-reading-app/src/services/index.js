...
// ======================== 工具函数导入 ========================
// formatter.js (命名导出)
export { formatDate, formatNumber, formatFileSize, formatPercentage } from '../utils/formatter'; // 添加 formatFileSize 和 formatPercentage
...
export function getCacheManager() {
  ...
  const cacheManagerModule = require('../utils/cache-manager'); // 导入整个模块
  return cacheManagerModule.getCacheManager(); // 调用函数获取实例
}
...
export function getErrorHandler() {
  ...
  return {
    configureGlobalErrorHandlers: errorHandlerModule.configureGlobalErrorHandlers,
